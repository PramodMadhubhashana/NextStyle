                ...
                <div style="display: flex; flex-direction: row; justify-content: space-between; margin-top: 50px;">
                    ...
                    <div class="itemlist">
                        ...
                        <div style="padding:20px; display: flex; flex-direction: column;">
                            <label style="font-size: 16px;">T-Shirt</label>
                            <label style="font-size: 16px; font-weight: 600; padding-top: 20px;">$123</label>
                        </div>
                        <div
                            style="display: flex; flex-direction: row; justify-content: space-between; padding: 0 10px 0 10px;">
                        ...
                        <div style="padding: 20px 10px 0 10px; display: flex; justify-content: space-between;">
                            <button class="button-32" role="button" style="background-color: #82b53f;">Add to
                                cart</button>
                        </div>
