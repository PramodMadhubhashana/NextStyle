    ...
    <div style="display: flex; flex-direction: column; margin: 50px; align-items: center;">
        ...
        <div
            ...
            <form>
                ...
                <input type="text" placeholder="Product Name" class="textbox" name="product Name" id="ProductName"
                    required>

                <label style="font-size: 20px;font-weight: 300; padding: 10px;">Enter Product Quantity</label>
                <input type="number" placeholder="Product Name" class="textbox" name="Quantity" id="Quantity" required>
